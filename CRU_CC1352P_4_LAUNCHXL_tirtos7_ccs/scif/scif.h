/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2022-07-13 15:44:15.590
...
#define SCIF_SYSTEM_AGC_MODES_CHANNEL_SIZE 6
/// System AGC: Top 20% of results from the samples
#define SCIF_SYSTEM_AGC_MODES_SIZE 24
...
#define SCIF_SYSTEM_AGC_MULTI_RESULT_SIZE 120
/// System AGC: Number of measures for a channel in a sample cycle.
#define SCIF_SYSTEM_AGC_RESULTS 30
...
typedef struct {
    uint16_t randomDelayDL[3]; ///< 
    uint16_t randomDelayUL[3]; ///< 
    uint16_t tddLock;          ///< 
...
typedef struct {
    ...
    uint16_t maxSamplesIFDL[24];         ///< 
    uint16_t maxSamplesIFUL[24];         ///< 
    uint16_t maxSamplesRFDL[24];         ///< 
    uint16_t maxSamplesRFUL[24];         ///< 
    uint16_t minSamplesIFDL[24];         ///< 
    uint16_t minSamplesIFUL[24];         ///< 
    uint16_t minSamplesRFDL[24];         ///< 
    uint16_t minSamplesRFUL[24];         ///< 
