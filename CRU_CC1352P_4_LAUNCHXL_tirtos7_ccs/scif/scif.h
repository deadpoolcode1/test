/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2022-07-06 11:15:31.096
...
typedef struct {
    ...
    uint16_t maxSamplesIFRX[24];         ///< 
    uint16_t maxSamplesIFTX[24];         ///< 
    uint16_t maxSamplesRFRX[24];         ///< 
    uint16_t maxSamplesRFTX[24];         ///< 
    uint16_t minSamplesIFRX[24];         ///< 
    uint16_t minSamplesIFTX[24];         ///< 
    uint16_t minSamplesRFRX[24];         ///< 
    uint16_t minSamplesRFTX[24];         ///< 
