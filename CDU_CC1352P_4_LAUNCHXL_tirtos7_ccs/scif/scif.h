/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     System AGC nizan
  ...
  * - <b>Created</b>:          2022-11-09 15:40:03.076
...
/// System AGC: 
#define SCIF_SYSTEM_AGC_SAMPLE_SZ 75
/// System AGC: 
...
typedef struct {
    ...
    uint16_t IFDetDLSamples[75];  ///< 
    uint16_t IFDetULMax[4];       ///< 
    uint16_t IFDetULMin[4];       ///< 
    uint16_t IFDetULSamples[75];  ///< 
    uint16_t RxDetMax[4];         ///< 
    uint16_t RxDetMin[4];         ///< 
    uint16_t RxDetSamples[75];    ///< 
    uint16_t TxDetMax[4];         ///< 
    uint16_t TxDetMin[4];         ///< 
    uint16_t TxDetSamples[75];    ///< 
    uint16_t adcValue;            ///< 
