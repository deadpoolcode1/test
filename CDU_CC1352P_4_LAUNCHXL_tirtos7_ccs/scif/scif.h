/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     System AGC CDU CODE
  * - <b>Project file</b>:     C:/Users/cellium/workspace_v12/crs_tirtos_test/CDU_CC1352P_4_LAUNCHXL_tirtos7_ccs/scif/system_agc_cdu.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2022-11-28 13:37:53.093
...
/// System AGC: 
#define SCIF_SYSTEM_AGC_SAMPLE_SZ 40
/// System AGC: 
...
typedef struct {
    ...
    uint16_t IFDetDLSamples[40];  ///< 
    uint16_t IFDetULMax[4];       ///< 
    uint16_t IFDetULMin[4];       ///< 
    uint16_t IFDetULSamples[40];  ///< 
    uint16_t RxDetMax[4];         ///< 
    uint16_t RxDetMin[4];         ///< 
    uint16_t RxDetSamples[40];    ///< 
    uint16_t TxDetMax[4];         ///< 
    uint16_t TxDetMin[4];         ///< 
    uint16_t TxDetSamples[40];    ///< 
    uint16_t adcValue;            ///< 
