...
static uint16_t crcTable[CRC_TAB_SIZE] = { 0x0000, 0x1021, 0x2042, 0x3063,
...
static uint8_t gStatusCommand[STATUS_REQ_NUM_BYTES] = { 0x16, 0x16, 0x16, 0x16,
                                                        0xFF, 0xFF, 0x00, 0x00,
                                                        0x00, 0x11, 0x0C };
...
uint16_t gConfigs[2][15] = { { 1214, 1642, 1714, 1785, 1857, 2214, 2642, 2714,
                               2785, 2857, 3214, 3642, 3714, 3785, 3857 },
                             { 6214, 6642, 6714, 6785, 6857, 7214, 7642, 7714,
                               7785, 7857, 8214, 8642, 8714, 8785, 8857 } };
...
{
    collectorSem = sem;
    tddClkHandle = UtilTimer_construct(&tddClkStruct, processTddTimeoutCallback,
                                       10, 0,
                                       false,
                                       0);
    return CRS_SUCCESS;
...
CRS_retVal_t Tdd_restart(TDD_cbFn_t _cbFn)
{
    ...
    uint8_t commandRequest[11] = { 0x16, 0x16, 0x16, 0x16, 0xff, 0xff, 0x10,
                                   0x0, 0x0, 0x52, 0x6f };
    //makeRequest(set, req);
...
static Tdd_setRequest_t createRequest()
{
    Tdd_setRequest_t request = { .dl1_us = NULL, .dl2_us = NULL, .ho_min = NULL,
                                 .ho_sec = NULL, .pattern1_period = NULL,
                                 .pattern2_period = NULL, .pattern2 = NULL,
                                 .rtg_vals = { NULL, NULL, NULL, NULL },
                                 .ttg_vals = { NULL, NULL, NULL, NULL }, .scs =
                                 NULL,
                                 .ss_pos = NULL, .detect = NULL };
    return request;
}
...
static void makeRequest(Tdd_setRequest_t request, uint8_t *request_array)
{
     ...
     */
    uint8_t set_request[45] = { 0x16, 0x16, 0x16, 0x16, 0xFF, 0xFF, 0x01, 0x00,
                                0x22, 0x00, 0x00 }; // 11 bytes
    uint8_t flag3 = 0x0;
