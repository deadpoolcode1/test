...
#define CLI_CRS_CONFIG_DIRECT_SPI "config direct spi" // todo
#define CLI_CRS_CONFIG_LINE_SPI "config line spi" // todo
#define CLI_CRS_CONFIG_FILE_SPI "config file spi" // todo
